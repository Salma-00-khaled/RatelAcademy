  ...
  return (
    <div className="about-container">
      <div className="about-content">
        <h1 className="about-title">عن أكاديمية رتل</h1>
        
        <div className="about-grid">
          <div className="about-text">
            <p>
              أكاديمية رتل لتحفيظ القرآن الكريم أونلاين، هي أكاديمية متخصصة في تعليم القرآن الكريم واللغة العربية عن بعد، للرجال والنساء والأطفال، بواسطة معلمين متخصصين حاصلين على إجازات بأعلى الأسانيد.
            </p>
          </div>
